...
<div class="list_form_background">
    ...
    <?= $form->field($model, 'type')->radioList(['1'=>'招聘','2'=>'求职']) ?>
    <?php ActiveForm::end(); ?>
    ...
    <div class="info-form-1">
        ...
        <?= $form->field($model, 'title')->textInput(['maxlength' => true,'class'=>'form-control list_form_title']); ?>

        <?= $form->field($model, 'identity')->radioList(['个人'=>'个人','中介'=>'中介']);  ?>
